...
Route::middleware('auth:sanctum')->get('/admin/detail', [AdminController::class, 'list']);// 관리자 상세
Route::middleware('auth:sanctum')->post('/admin/regist', [AdminController::class, 'regist']);// 관리자 상세
